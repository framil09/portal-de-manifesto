...
export const config = {
  ...
  smtpOAuthClientId: process.env.SMTP_OAUTH_CLIENT_ID || process.env.GOOGLE_CLIENT_ID || "",
  smtpOAuthClientSecret: process.env.SMTP_OAUTH_CLIENT_SECRET || process.env.GOOGLE_CLIENT_SECRET || "",
  smtpOAuthRefreshToken: process.env.SMTP_OAUTH_REFRESH_TOKEN || process.env.GOOGLE_REFRESH_TOKEN || "",
  smtpOAuthAccessToken: process.env.SMTP_OAUTH_ACCESS_TOKEN || process.env.GOOGLE_ACCESS_TOKEN || "",
